...
@Slf4j
class DataLoader implements ApplicationEventListener<ServiceStartedEvent> {

    final FileInfoRepository fileInfoRepository

    DataLoader(final FileInfoRepository fileInfoRepository) {
    ...
    public void onApplicationEvent(final ServiceStartedEvent event) {
        ...
        fileInfoRepository.initialize(20)
    }
}
